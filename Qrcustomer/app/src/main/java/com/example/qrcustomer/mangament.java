...
public class mangament extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mangament);
        ...
        PrimaryDrawerItem item8 = new PrimaryDrawerItem() .withIdentifier(8).withName("الادارة").withIcon(R.drawable.aaa);

        PrimaryDrawerItem item2 = new PrimaryDrawerItem() .withIdentifier(2) .withName ("المحلا").withIcon (R.drawable.aaa);
                ...
                .withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        if (drawerItem.getIdentifier ()==1) {
                            Intent a = new Intent (mangament.this,sign.class);
                            startActivity (a);

                        }

                        if (drawerItem.getIdentifier ()==2) {
                            Intent b = new Intent (mangament.this,store.class);
                            startActivity (b);
                        ...
                        if(drawerItem.getIdentifier ()==3) {
                            ...
                            Intent c = new Intent (mangament.this, Terms.class);
                            startActivity (c);
                        }

                        if(drawerItem.getIdentifier ()==4) {

                            Intent d = new Intent (mangament.this, store.class);
                            startActivity (d);
                        }

                        if(drawerItem.getIdentifier ()==5) {

                            Intent e = new Intent (mangament.this, ask.class);
                            startActivity (e);
                        }

                        if(drawerItem.getIdentifier ()==6) {

                            Intent e = new Intent (mangament.this, support.class);
                            startActivity (e);
                        }
                        ...
                        if(drawerItem.getIdentifier ()==7) {
                            ...
                            Intent f = new Intent (mangament.this,sign.class);
                            startActivity (f);
                        }

                        if ( drawerItem.getIdentifier()==8) {
                            Intent g = new Intent(mangament.this, booking.class);
                            startActivity(g);
                        }
