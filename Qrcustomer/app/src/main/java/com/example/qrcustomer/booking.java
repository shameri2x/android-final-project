...
public class booking extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        @SuppressLint("ResourceAsColor") AccountHeader hr = new AccountHeaderBuilder()
                ...
                .addProfiles(new ProfileDrawerItem().withName ("خسابي").withEmail(null).withIcon (R.drawable.aaa))
                .build ();
        ...
        SecondaryDrawerItem item5 = new SecondaryDrawerItem () .withIdentifier(5) .withName ("الاسئة").withIcon (R.drawable.aaa);
                ...
                .withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        if (drawerItem.getIdentifier ()==1) {
                            Intent a = new Intent (booking.this,sign.class);
                            startActivity (a);

                        }

                        if (drawerItem.getIdentifier ()==2) {
                            Intent b = new Intent (booking.this,store.class);
                            startActivity (b);
                        ...
                        if(drawerItem.getIdentifier ()==3) {
                            ...
                            Intent c = new Intent (booking.this, Terms.class);
                            startActivity (c);
                        }
                        ...
                        if(drawerItem.getIdentifier ()==5) {
                            ...
                            Intent e = new Intent (booking.this, ask.class);
                            startActivity (e);
                        }

                        if(drawerItem.getIdentifier ()==6) {

                            Intent e = new Intent (booking.this, support.class);
                            startActivity (e);
                        }
                        ...
                        if(drawerItem.getIdentifier ()==7) {
                            ...
                            Intent f = new Intent (booking.this,sign.class);
                            startActivity (f);
                        }
