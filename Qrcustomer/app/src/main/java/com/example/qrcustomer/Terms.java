...
public class Terms extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolBar.setNavigationIcon (R.drawable.whitehamburger);
                ...
                .withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        if (drawerItem.getIdentifier ()==2) {
                            Intent b = new Intent (Terms.this,store.class);
                            startActivity (b);
                        ...
                        if(drawerItem.getIdentifier ()==5) {
                            ...
                            Intent e = new Intent (Terms.this, ask.class);
                            startActivity (e);
                        }

                        if(drawerItem.getIdentifier ()==6) {

                            Intent e = new Intent (Terms.this, support.class);
                            startActivity (e);
                        }
                        ...
                        if(drawerItem.getIdentifier ()==7) {
                            ...
                            Intent f = new Intent (Terms.this,sign.class);
                            startActivity (f);
                        }
